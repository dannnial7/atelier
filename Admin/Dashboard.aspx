    ...
    <div class="admin-wrapper">
        ...
        <div class="admin-main">
            ...
            <div class="admin-header">
                <div>
                    <h2>Dashboard</h2>
                    <p class="text-muted"> Welcome back, <asp:Label ID="lblAdminName" runat="server"/> </p>
                ...
                <div class="grid-stats">
                    ...
                    <div class="stat-card">
                        <div class="stat-number"> <asp:Label ID="lblTotalRevenue" runat="server" Text="RM0" />
                ...
                <div class="chart-container">
                    ...
                    <table> <tr> <th>Learner</th>
                        <th>Course</th>
                        <th>Date</th>
                        <th>Progress</th>
                            </tr>
                        <asp:Repeater ID ="rptEnrollments" runat="server"> <ItemTemplate>
                            <tr>
                                <td><%# Eval("FullName") %></td>
                                <td><%# Eval("Title") %></td>
        ...
        <script type="text/javascript">
            ...
            new Chart(document.getElementById('enrolmentChart'), {
                type: 'bar',
                data: {
                    labels: enrolmentData.labels, datasets: [{
                        label: 'Enrollments',
                        data: enrolmentData.data, backgroundColor: '#6B1A2A', borderRadius: 6
                    }]
                },
                options: {
            ...
            new Chart(document.getElementById('userChart'), {
                type: 'doughnut',
                data: {
                    labels: userData.labels, datasets: [{ data: userData.data, backgroundColor: ['#6B1A2A', '#BFCFE8'] }]
