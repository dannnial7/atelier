...
<asp:Content ID="MainContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="container" style="margin-top:40px">
        ...
        <asp:Panel ID="pnlCourse" runat="server">
            ...
            <div class="card course-detail-card" style="margin-bottom:28px;">
            ...
            <div class="card course-detail-card">
                <h2 class="section-title" style="margin-top:0;margin-bottom:24px;font-size:24px;">Course Modules & Materials</h2>

                <asp:Repeater ID="rptModules" runat="server">
                    <ItemTemplate>
                        <div class="card-sm course-module-item">
                            <div style="display:flex;justify-content:space-between;align-items:flex-start;gap:16px;">
                                <div style="flex:1;">
                                    <strong style="font-size:17px;"><%# Eval("OrderIndex") %>. <%# Eval("Title") %></strong>
                                    ...
                                    <p style="margin-top:10px;font-size:14px;line-height:1.55;margin-bottom:0;">
                                        <%# Eval("Description") %>
                                    </p>
                                </div>
            ...
            <asp:Panel ID="pnlAssessmentSection" runat="server" Visible="false" class="card course-detail-card" style="margin-top:24px;">
                <div style="display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:16px;">
                    <div>
                        <h2 class="section-title" style="margin:0;font-size:24px;">Course Assessment Quiz</h2>
                        <p style="margin-top:6px;font-size:15px;margin-bottom:0;">
