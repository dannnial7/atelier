...
<asp:Content ID="MainContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="container" style="margin-top:40px">
        ...
        <asp:Panel ID="pnlAccessDenied" runat="server" Visible="false" CssClass="card" style="margin-top:24px;text-align:center;padding:40px 20px;background:var(--card-bg, #ffffff);box-shadow:0 10px 30px rgba(0,0,0,0.12);border-radius:16px;">
        ...
        <asp:Panel ID="pnlModule" runat="server">
            ...
            <div class="card" style="margin-bottom:24px;padding:32px;background:var(--card-bg, #ffffff);box-shadow:0 10px 30px rgba(0,0,0,0.12);border-radius:16px;">
                <p class="course-meta" style="margin-bottom:12px;">
                    <asp:HyperLink ID="lnkBackToCourse" runat="server" Text="&larr; Back to course" style="font-weight:600;" />
                </p>

                <h1 style="margin-top:0;font-size:30px;"><asp:Literal ID="litTitle" runat="server" /></h1>
                <p class="course-meta" style="margin-top:6px;font-size:15px;">
            ...
            <asp:Panel ID="pnlModuleContent" runat="server">
                ...
                <asp:Panel ID="pnlPdf" runat="server" Visible="false" CssClass="card" style="padding:32px;background:var(--card-bg, #ffffff);box-shadow:0 10px 30px rgba(0,0,0,0.12);border-radius:16px;">
                ...
                <div class="card" style="margin-top:24px;padding:32px;background:var(--card-bg, #ffffff);box-shadow:0 10px 30px rgba(0,0,0,0.12);border-radius:16px;">
                    ...
                    <asp:Panel ID="pnlNotCompleted" runat="server">
                        <p style="font-size:16px;font-weight:600;">Finished with this module?</p>
                ...
                <div class="card" style="margin-top:24px;padding:32px;background:var(--card-bg, #ffffff);box-shadow:0 10px 30px rgba(0,0,0,0.12);border-radius:16px;">
                    <h4 style="margin-top:0;">My Notes</h4>
